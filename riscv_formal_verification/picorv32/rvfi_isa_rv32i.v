...
`endif 
/*
    assign spec_valid = spec_insn_addi_valid;
		assign spec_trap = spec_insn_addi_trap;
		assign spec_rs1_addr = spec_insn_addi_rs1_addr;
		assign spec_rs2_addr = spec_insn_addi_rs2_addr;
		assign spec_rd_addr = spec_insn_addi_rd_addr ;
		assign spec_rd_wdata = spec_insn_addi_rd_wdata ;
		assign spec_pc_wdata = spec_insn_addi_pc_wdata ;
		assign spec_mem_addr = spec_insn_addi_mem_addr;
		assign spec_mem_rmask = spec_insn_addi_mem_rmask;
		assign spec_mem_wmask = spec_insn_addi_mem_wmask;
		assign spec_mem_wdata = spec_insn_addi_mem_wdata;
*/
endmodule
